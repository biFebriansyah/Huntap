	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<?php elseif(!empty($result)): ?>
				...
				<h4>Nama Warga</h4>
				<p><?php echo $result['nama_warga']; ?></p>
				...
				<p><a href="edit-warga.php?id=<?php echo $id_warga; ?>" class="button"><span class="fa fa-pencil"></span> Edit</a> &nbsp; <a href="hapus-warga.php?id=<?php echo $id_warga; ?>" class="button button-red yaqin-hapus"><span class="fa fa-times"></span> Hapus</a></p>
