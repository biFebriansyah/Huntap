				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-warga.php">Data Warga</a>
								<ul>
									<li><a href="list-warga.php">List Warga</a></li>
									<li><a href="tambah-warga.php">Tambah Warga</a></li>
								</ul>
							</li>
						<?php endif; ?>
						<li><a href="ranking-saw.php">Ranking</a>
						<!--	<ul>
